  ...
  export default () => {
    ...
    return (
	  ...
	  <Paragraph align="middle" >
          <div style={{"width":"70%"}}>
            这里是 (<a href='https://asoul.niaohan.top/#/./index'>源站</a>),这里是 (<a href='https://gitasoul.niaohan.top/#/./index'>镜像站</a>)。
          </div>
        </Paragraph>
	  ...
	  <Row>
            <Col md={{"offset":6,"span":3}}><li>运营者:</li></Col>
            <Col md={3}><a href="https://github.com/haibara-jian"><GithubFilled/></a>Github主页</Col>
            <Col><a href="https://space.bilibili.com/6175388"><IconFont type="icon-icon_bilibili-circle" /></a>B站主页</Col>
          </Row>
        ...
        <Paragraph align="middle" >
          <div style={{"width":"70%"}}>
            ...
            在网站开发过程中使用到了闭源的前端框架Crgc(<a href='https://www.bilibili.com/video/BV14y4y1M7cC'>Courageous Cattle</a>),在此特别鸣谢。
          </div>
        </Paragraph>
        <Paragraph></Paragraph>
